...
class Order(Base):
    ...
    counterparty_id = Column(Integer, ForeignKey(
        'orders.id'))  # If the order was filled (or partially filled) the order_id of the order that acted as the
    # counterparty
    counterparty = relationship("Order",
